...
<body>
    <div style="display: flex; flex-direction: column; padding-left: 4rem; border-left: 1px solid #e2e8f0; border-color: #e2e8f0">
        <p style="font-weight: 500; font-size: 2.5rem; margin-top: 2rem">Edit Data Character</p>
        <div style="width: 60%">
            <form action="" method="post" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?= $data['id']; ?>">
                <div style="display: flex; margin-top: 1rem">
                    <p style="width: 16rem; padding-top: 0.5rem; padding-bottom: 0.5rem">Name :</p>
                    <input type="text" name="name" id="name" value="<?= $data['name']; ?>" style="padding-left: 1rem; padding-top: 0.25rem; padding-bottom: 0.25rem; border-radius: 0.5rem; border: 1px solid black; width: 100%" placeholder="Name" />
                </div>
                <div style="display: flex; margin-top: 1rem">
                ...
                <div style="display: flex; margin-top: 1rem">
                    ...
                    <div style="display: flex; width: 100%">
                        ...
                        <button type="submit" name="editCaster" style="border-radius: 0.5rem; background-color: #474e9c; color: white; padding-left: 1rem; padding-right: 1rem; padding-top: 0.25rem; padding-bottom: 0.25rem; margin-left: 0.25rem">Submit</button>
                    </div>
                </div>
            </form>
        </div>
