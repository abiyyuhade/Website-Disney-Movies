...
<body>
    <div style="display: flex; flex-direction: column; padding-left: 4rem; border-left: 1px solid #e2e8f0; border-color: #e2e8f0">
        <p style="font-weight: 500; font-size: 2.5rem; margin-top: 2rem">Add Data Movie</p>
        <form action="" method="post" enctype="multipart/form-data">
            <div style="width: 35%">
                <div style="display: flex; margin-top: 1rem">
                    <p style="width: 8rem; padding-top: 0.5rem">Title :</p>
                    <input type="text" name="title" id="title" autocomplete="off" style="padding-left: 1rem; padding-top: 0.25rem; padding-bottom: 0.25rem; border-radius: 0.5rem; border: 1px solid black; width: 100%" placeholder="Title" />
                </div>
                <div style="display: flex; margin-top: 1rem">
                    <p style="width: 8rem; padding-top: 0.5rem">Synopsis :</p>
                    <textarea name="synopsis" style="padding-left: 1rem; padding-top: 0.25rem; padding-bottom: 0.25rem; border-radius: 0.5rem; border: 1px solid black; width: 100%; height: 8rem" placeholder="Synopsis"></textarea>
                </div>
                <div style="display: flex; margin-top: 1rem">
                    <p style="width: 8rem; padding-top: 0.5rem">Release Year :</p>
                    <input type="number" name="year" id="year" autocomplete="off"" style=" padding-left: 1rem; padding-top: 0.25rem; padding-bottom: 0.25rem; border-radius: 0.5rem; border: 1px solid black; width: 100%" placeholder="Release Year" />
                </div>
                <div style="display: flex; margin-top: 1rem">
                    <p style="width: 8rem; padding-top: 0.5rem">Director :</p>
                    <input type="text" name="director" id="director" autocomplete="off" style="padding-left: 1rem; padding-top: 0.25rem; padding-bottom: 0.25rem; border-radius: 0.5rem; border: 1px solid black; width: 100%" placeholder="Director" />
                </div>
                <div style="display: flex; margin-top: 1rem">
                ...
                <div style="display: flex; margin-top: 1rem">
                    ...
                    <div style="display: flex; width: 100%">
                        <button onclick="window.location='../adminMovie.php'" style="border-radius: 0.5rem; border: 1px solid #474e9c; padding-left: 1rem; padding-right: 1rem; padding-top: 0.25rem; padding-bottom: 0.25rem">Cancel</button>
                        <button type="submit" name="addMovie" style="border-radius: 0.5rem; background-color: #474e9c; color: white; padding-left: 1rem; padding-right: 1rem; padding-top: 0.25rem; padding-bottom: 0.25rem; margin-left: 0.25rem">Submit</button>
                    </div>
                </div>
            </div>
        </form>
